...
- **Retention** — agent rebooking cockpit, brokerage portfolio dashboard/portal, revenue optimizer, filtered acquisition tracking with referral attribution, intro emails, per-agent summaries, follow-up queue, and repeat-agent reports
